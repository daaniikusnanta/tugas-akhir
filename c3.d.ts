...
interface IGlobalVars extends VariableType {
	...
	["tickRate"]: number
	/**  **/
	readonly ["minTickRate"]: number
	/**  **/
	readonly ["maxTickRate"]: number
}
...
interface ITickRateBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITickRate extends ITextInstance {
	instVars: ITickRateVars;
	behaviors: ITickRateBehaviors;
}

interface ITickBarVars extends VariableType {
	
}
interface ITickBarBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface ITickBar extends IWorldInstance {
	instVars: ITickBarVars;
...
interface IInflationStatusBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IInflationStatus extends ITextInstance {
	instVars: IInflationStatusVars;
	behaviors: IInflationStatusBehaviors;
}

interface IInflationStateVars extends VariableType {
	
}
interface IInflationStateBehaviors extends Record<string, IBehaviorInstance> {
...
interface IGameManagerBehaviors extends Record<string, IBehaviorInstance> {
	['Timer']: IBehaviorInstance
}
interface IGameManager extends ISpriteInstance {
	instVars: IGameManagerVars;
	behaviors: IGameManagerBehaviors;
}

interface IDayVars extends VariableType {
	
}
interface IDayBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IDay extends ITextInstance {
	instVars: IDayVars;
	behaviors: IDayBehaviors;
}

interface IButtonPauseVars extends VariableType {
	
}
interface IButtonPauseBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IButtonPause extends IButtonInstance {
	instVars: IButtonPauseVars;
	behaviors: IButtonPauseBehaviors;
}

interface IButtonInreaseVars extends VariableType {
	
}
interface IButtonInreaseBehaviors extends Record<string, IBehaviorInstance> {
	
}
interface IButtonInrease extends IButtonInstance {
	instVars: IButtonInreaseVars;
	behaviors: IButtonInreaseBehaviors;
}

interface IButtonDecreaseVars extends VariableType {
	
}
interface IButtonDecreaseBehaviors extends Record<string, IBehaviorInstance> {
